...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      /*
       * `prompt`, et non `autoUpdate`. La grille vit dans le navigateur et
      ...
      manifest: {
        id: '/app',
        name: 'habit. — suivi d’habitudes',
        short_name: 'habit.',
        description:
          'Une semaine. Une grille. Local, hors ligne, sans compte.',
        lang: 'fr',
        dir: 'ltr',
        start_url: '/app',
        scope: '/',
        display: 'standalone',
        // Pas de verrou d'orientation : la grille de sept colonnes tient dans
        // les deux sens, et c'est en paysage qu'une tablette montre le mois.
