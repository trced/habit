/*
 * habit. — un suivi d'habitudes personnel qui s'exécute sur votre appareil.
 * Copyright (C) 2026  les auteurs de habit.
 *
 ...
 *
 * Contact : contact@habit.app — code source : https://github.com/trced/habit
 *
...
import { hasHabits } from './lib/storage.ts'
...
/** Arriver sur « / » avec un suivi déjà commencé ouvre l'application : la
...
if (window.location.pathname === '/' && hasHabits()) {
