...
const LOOP: [MessageKey, MessageKey][] = [
  ['site.home.loop.define', 'site.home.loop.defineBody'],
  ['site.home.loop.check', 'site.home.loop.checkBody'],
  ['site.home.loop.look', 'site.home.loop.lookBody'],
]

const HINTS: MessageKey[] = [
  'site.home.appHint.week',
  'site.home.appHint.summary',
        ...
        <div className="showcase">
          {showApp ? (
            <div className="showcase__frame">
              <DemoStoreProvider names={t('app.demo.habits').split(',')}>
                <HabitApp embedded />
              </DemoStoreProvider>
